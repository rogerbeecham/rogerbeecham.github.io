...
<img src = "img/framework_examples.png", width = 80%, style = "position:absolute; top: 30%; left: 12%;"></img>
...
<img src = "img/framework_phase_3.png", width = 80%, style = "position:absolute; top: 30%; left: 12%;"></img>
...
<img src = "img/analysis1.png", width = 70%, style = "position:absolute; top: 55%; left: 16%;"></img>


.xtiny-font[
> *EDA is usually an iterative process of model specification, residual analysis, examination of assumptions, and model pre-specification to find patterns and reveal data structure.*
>
> Devezer et al. 2021
]
...
<img src = "img/analysis2.png", width = 62%, style = "position:absolute; top: 50%; left: 16%;"></img>
...
<img src = "img/analysis_1_gradients.png", width = 49%, style = "position:absolute; top: 47%; left: 16%;"></img>
...
<img src = "img/bayesian_map.png", width = 35%, style = "position:absolute; top: 47%; left: 16%;"></img>
<img src = "img/bayesian_formula.png", width = 35%, style = "position:absolute; top: 60%; left: 55%;"></img>
...
<img src = "img/analysis2_observed.png", width = 24%, style = "position:absolute; top: 52%; left: 16%;"></img>
--
<img src = "img/analysis2_lineup.png", width = 36%, style = "position:absolute; top: 43%; left: 45%;"></img>

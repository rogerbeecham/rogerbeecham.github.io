...
pub-info:
  reference: >-
    <strong>Roger Beecham</strong> and <a href="https://www.robinlovelace.net/">Robin Lovelace</a> (2023) “A framework for inserting visually-supported inferences into geographical analysis workflow: application to road crash analysis”, <em>Geographical Analysis</em>, doi: <a href="https://doi.org/10.1111/gean.12338"><code>110.1111/gean.12338</code></a>
  links:
    - name: Final version

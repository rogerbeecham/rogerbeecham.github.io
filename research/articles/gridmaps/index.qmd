...
pub-info:
  reference: >-
    <strong>Roger Beecham</strong>,Martijn Tennekes and Jo Wood (2026) “gridmappr: An R package for creating small multiple gridmap layouts”, <em>Environment & Planning B: Urban Analytics and City Science</em>, doi: <a href="https://doi.org/10.1177/23998083251374737"><code>10.1177/23998083251374737</code></a>
  links:
    - name: Final version
...
```bibtex
@article{beecham_gridmappr_2026,
